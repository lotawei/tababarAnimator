...
//    var textSelectedColor: UIColor =  LLCurrentUser.currentuser == nil  ?  normalcolor : LLCurrentUser.currentuser.user.substyle.substylecolor()
    var textSelectedColor: UIColor = UIColor.black //字体有颜色
...
class LLAnimationTabBarController: UITabBarController {
    ...
    var iconsImageName:[String] = ["bird", "bee"]
    var iconsSelectedImageName:[String] = ["bee", "bird"]
